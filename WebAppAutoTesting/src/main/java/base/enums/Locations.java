...
public int getWoeidVal( )
{
	int woeidVal = Integer.parseInt(woeidStr);
	return woeidVal;
}
...
Locations( final String city, final States state, final String woeid, final double latit, final double longit )
{
	this.cityName = city;
	this.state = state;
	this.woeidStr = woeid;
